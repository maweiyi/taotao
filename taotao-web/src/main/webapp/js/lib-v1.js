...
!function() {
    ...
    var a = $("#me.maweiyi.bean.service-2013 a[href='http://en.360buy.com/']");
...
!function() {
    pageConfig.FN_ImgError(document), $("img[data-lazyload]").Jlazyload({type: "image",placeholderClass: "err-product"}), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({delay: 50}) : ($("#biz-me.maweiyi.bean.service").Jdropdown({delay: 50}, function() {
