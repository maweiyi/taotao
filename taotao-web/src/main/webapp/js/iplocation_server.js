...
//        $("#summary-me.maweiyi.bean.service").html("");
//        if (p.PopType==999||p.Ext.indexOf("factoryShip")!=-1){
//            $("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由厂家或供应商提供和配送。"+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//        }else{
//            var upenCheckStr = "";
//            if (p.code==1&&openCheck&&!iconDesc&&!checkApecialAttr("YuShou")){
//                upenCheckStr = "，支持货到付款、开箱验机";
//            }
//            $("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由 京东 发货并提供售后服务"+upenCheckStr+"。"+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//        }
    }
    if (pageConfig.product.skuid>1000000000){   
        if (r){
...
//                if($("#summary-me.maweiyi.bean.service").length==0){$("<li id='summary-me.maweiyi.bean.service'></li>").insertAfter("#summary-stock");}
//                $("#summary-me.maweiyi.bean.service").html("");
...
//						getPOPDeliveCash();
//					}
//					$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由 京东 负责发货，<a href='#none'>"+r.vender+"</a> 完成售后服务。"+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//				}
//				else{
//					if(r.type==0){
...
//							+"<span id='loc_enddate'>"+(locSkuEndDate?("，"+locSkuEndDate):"。")+"</span>"+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//						}
//						else{
//							requestDeliveCash = true;
//							getPOPDeliveCash();
...
//							+shinfo+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//						}
//					}
//					else if(r.type==1){
//						$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由 京东 发货并提供售后服务。"+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//					}
//					else if(r.type==2){
//						$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由<a href='"+$.getShopUrl(r)+"' "+(pageConfig.product.isFlashPurchase?"":"target='_blank'")+" clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>"+dfinfo+"发货，京东提供售后服务。"+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//					}
//					else if(r.type==5){
//						$("<div class='dt'>服\u3000\u3000务：</div><div class='dd'>由<a href='"+$.getShopUrl(r)+"' "+(pageConfig.product.isFlashPurchase?"":"target='_blank'")+" clstag='shangpin|keycount|product|bbtn' class='hl_red'>"+r.vender+"</a>"+dfinfo+"发货，"+shinfo+iconDesc+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//					}
//				}
//                if(pageConfig.product.yfinfo&&pageConfig.product.yfinfo.me.maweiyi.bean.service){
//                    $("<div class='dt'>\u3000\u3000</div><div class='dd'>"+pageConfig.product.yfinfo.me.maweiyi.bean.service+"</div>").appendTo("#summary-me.maweiyi.bean.service");
//                }
//                if(r.type!=4){
        ...
        if(dCashDescInfo.loadPriceCnt==dCashDescInfo.loadStockCnt&&dCashDescInfo.bigger39&&!dCashDescInfo.dCash){
            if(type == 1){ //stock
                ...
                if($("#promise-ico").length>0){
                    ...
                    $('<span id="promise-ico">支持：<a href="http://help.jd.com/help/question-892.html#help2215" target="_blank" class="free_delivery" title="了解配送费收取标准"></a></span>').appendTo("#summary-me.maweiyi.bean.service .dd");
                }
            }
        }
    }
